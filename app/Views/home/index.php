<div class="container">
    ...
    <div class='row intro-hero'>
        ...
        <div class='col-md-12 intro-hero-shadow'>
            ...
            <button class='btn started mt-4' id='btnRegisterPage'> Get started</button>
        </div>
                ...
                <div class='mt-4 p-4'>
                    ...
                    <div class='mx-auto d-block w-auto' >
                        ...
                        <p>
                            ...
                            experts to
                            create our interactive online document generator. Enter your information, and we'll create a last
...
<div class='container bg-white shadow-lg mt-5 rounded service'>
    <div class='row'>
        <div class='col-sm p-4 hero'>
            ...
            <h3 style='text-align: center; color: rgb(56, 56, 56); font-weight: 400;'><i class="bi bi-book"
                    style='margin: 10px;'></i>Legal
    ...
    <div class='row m-0 p-0'>
        ...
        <ul class="list-group space hero-list m-0 p-0">
            ...
            <li class="list-group-item">
                <h2 style='font-weight: bolder;'>1: Fill out online</h2>
                <p class='list-guide' style='text-align:start; margin-left: 3em;'>
            ...
            <li class="list-group space">
                ...
                <p class='list-guide' style='text-align:start; margin-left: 3em;'>The information you provided is turned into precise legal
            ...
            <li class="list-group-item">
                ...
                <p class='list-guide' style='text-align: start; margin-left: 3em;'>
                    Follow attached instructions to print, sign, and make your document official. Keep it somewhere
                    safe, but accessible! </p>
            </li>
        </ul>
